...
return (
        <div>
                <div>
                        <AttrBox desc={intl.formatMessage(messages.email)} attrType='email' content={props?.data?.email}></AttrBox>
                        <AttrBox desc={intl.formatMessage(messages.phone)} attrType='phone' content={props.data?.telefon}></AttrBox>
                        {isOrt && <AttrBox desc="Ort" content={props?.data?.ort}></AttrBox>}
                </div>
                <div>
                        <h3 style={{ marginBottom: '0.25rem', fontSize: '1.3rem' }}> <FormattedMessage id="staff" /> </h3>
                        <table>
                        ...
                        <h3 style={{ marginBottom: '0.25rem', marginTop: '0.25rem' }}> <FormattedMessage id="attendance_times" /> </h3>
                        <table>
